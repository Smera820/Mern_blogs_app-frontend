...
function Menu() {
  ...
  return (
    <div className='bg-black w-[200px] z-10 flex flex-col item-start absolute top-12 right-6 md:right-32 rounded-md p-4 space-y-4'>
      {
        !user && <h3 className='text-white text-sm hover:text-grey-500 cursor-pointer'>
      ...
      {
        user && <h3 className='text-white text-sm hover:text-grey-500 cursor-pointer' onClick={handleLogout()}>
          Logout
